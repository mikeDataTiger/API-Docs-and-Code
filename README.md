# DataTiger OpenAPI Specification
...
6. If you did everything correct, https://datatigergithub.github.io/API-Docs-and-Code/ will lead to your new docs
...
- Documentation(ReDoc): https://datatigergithub.github.io/API-Docs-and-Code/
- SwaggerUI: https://datatigergithub.github.io/API-Docs-and-Code/swagger-ui/
- Look full spec:
    + JSON https://datatigergithub.github.io/API-Docs-and-Code/swagger.json
    + YAML https://datatigergithub.github.io/API-Docs-and-Code/swagger.yaml
- Preview spec version for branch `[branch]`: https://datatigergithub.github.io/API-Docs-and-Code/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://datatigergithub.github.io/API-Docs-and-Code/ with url from the message: `Server started <url>`
